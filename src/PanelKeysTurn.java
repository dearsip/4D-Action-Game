...
public class PanelKeysTurn extends PanelKeys {

// --- constants ---

   private static int[] myindex = new int[] { OptionsKeys.KEY_TURN_LEFT,
                                              OptionsKeys.KEY_TURN_RIGHT,
                                              OptionsKeys.KEY_TURN_UP,
                                              OptionsKeys.KEY_TURN_DOWN,
                                              OptionsKeys.KEY_TURN_IN,
                                              OptionsKeys.KEY_TURN_OUT };

// --- construction ---

   public PanelKeysTurn() {
      super(myindex);
